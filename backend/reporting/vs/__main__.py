"""Run the VS reporting consumer:  python -m backend.reporting.vs
...
_ROOT = pathlib.Path(__file__).resolve().parents[3]  # vs -> reporting -> backend -> ROOT
...
from backend.reporting.vs.consumer import run  # noqa: E402
