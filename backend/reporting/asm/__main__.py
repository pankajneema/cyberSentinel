"""Run the ASM reporting consumer:  python -m backend.reporting.asm
...
_ROOT = pathlib.Path(__file__).resolve().parents[3]  # asm -> reporting -> backend -> ROOT
...
from backend.reporting.asm.consumer import run  # noqa: E402
